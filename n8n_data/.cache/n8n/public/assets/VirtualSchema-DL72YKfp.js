...
import { _t as useI18n, h as computedAsync, vt as I18nT } from "./_MapCache-D-6DBsTy.js";
import { On as N8nText_default, St as N8nTooltip_default, jn as N8nIcon_default, kn as N8nButton_default, xt as N8nLink_default } from "./src-BjCe3xxd.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-fRq25RGE.js";
import { y as useRouter } from "./truncate-CiSH3Avz.js";
import { C as useNodeTypesStore, Ft as useNDVStore, It as injectWorkflowState, Ki as isEmpty, Mt as useTelemetry, Sr as useExternalHooks, br as useToast, ct as useFlattenSchema, gr as useMessage, hi as executionDataToJson, it as generateCodeForPrompt, jt as useNodeHelpers, kt as environments_store_default, ls as useSettingsStore, na as nodeViewEventBus, r as useUIStore, s as useWorkflowsStore, st as useDataSchema } from "./users.store-p-3LYLwz.js";
import { Ja as AI_TRANSFORM_CODE_GENERATED_FOR_PROMPT, N as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Rt as CHAT_TRIGGER_NODE_TYPE, S as SCHEMA_PREVIEW_DOCS_URL, So as ApplicationError, Ua as DateTime, Wa as NodeConnectionTypes, Xa as AI_TRANSFORM_NODE_TYPE, Ya as AI_TRANSFORM_JS_CODE, Zo as FROM_AI_PARAMETERS_MODAL_KEY, bc as EnterpriseEditionFeature, hr as WEBHOOK_NODE_TYPE, ii as require_pick, is as MODAL_CONFIRM, ln as FORM_TRIGGER_NODE_TYPE, wi as createResultError, wn as MANUAL_TRIGGER_NODE_TYPE } from "./constants-C6S5WPU1.js";
import { r as useRootStore } from "./_baseOrderBy-BY4x0dN2.js";
import { i as Ln, o as gu, r as estree_exports, t as NDVEmptyState_default } from "./NDVEmptyState-SCsOPB6e.js";
...
import { n as MappingPill_default, t as useTelemetryContext } from "./useTelemetryContext-DcVsDd6M.js";
import { i as useSchemaPreviewStore, t as useRunWorkflow } from "./useRunWorkflow-a0FS5Kub.js";
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$3, [createBaseVNode("div", _hoisted_2$2, [
				...
				createBaseVNode("div", _hoisted_3, [createTextVNode(toDisplayString(__props.title) + " ", 1), __props.info ? (openBlock(), createElementBlock("span", _hoisted_4, toDisplayString(__props.info), 1)) : createCommentVNode("", true)]),
...
var VirtualSchemaItem_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	emits: ["click"],
	setup(__props, { emit: __emit }) {
		useCssVars((_ctx) => ({ "v8de62a40": _ctx.level }));
		const props$1 = __props;
		const emit = __emit;
		return (_ctx, _cache) => {
