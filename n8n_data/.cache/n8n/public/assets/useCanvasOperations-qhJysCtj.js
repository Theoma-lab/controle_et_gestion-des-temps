...
import { C as computed, G as nextTick, It as ref, zt as shallowRef } from "./vue.runtime.esm-bundler-XtMkEjzB.js";
import { M as useLocalStorage, S as useClipboard, _t as useI18n } from "./_MapCache-D-6DBsTy.js";
import { T as createEventBus, v as useRoute, y as useRouter } from "./truncate-CiSH3Avz.js";
import { $i as tryToParseNumber, $r as useHistoryStore, An as getNodesGroupSize, C as useNodeTypesStore, Cn as generateOffsets, Dr as v4_default, Dt as useTagsStore, Ft as useNDVStore, It as injectWorkflowState, Ji as isPresent, Kr as isValidNodeConnectionType, Lt as useWorkflowState, Mt as useTelemetry, On as getNewNodePosition, Qr as CanvasNodeRenderType, Sn as doRectsOverlap, Sr as useExternalHooks, Xr as CanvasConnectionMode, _n as DEFAULT_NODE_SIZE, ai as MoveNodeCommand, bn as PUSH_NODES_OFFSET, br as useToast, ci as RenameNodeCommand, cn as useFocusPanelStore, d as isChatNode, ei as AddConnectionCommand, gn as CONFIGURATION_NODE_SIZE, jt as useNodeHelpers, li as ReplaceNodeParametersCommand, ls as useSettingsStore, mn as CONFIGURABLE_NODE_SIZE, nt as useCredentialsStore, oi as RemoveConnectionCommand, pn as useTemplatesStore, pr as useCanvasStore, r as useUIStore, s as useWorkflowsStore, si as RemoveNodeCommand, st as useDataSchema, ti as AddNodeCommand, vn as DEFAULT_VIEWPORT_BOUNDARIES, wr as usePostHog, wt as useWorkflowHelpers, y as getExecutionErrorToastConfiguration, yn as GRID_SIZE, zt as useProjectsStore } from "./users.store-p-3LYLwz.js";
import { $i as getNodeParameters, Ea as isCommunityPackageName, En as MCP_TRIGGER_NODE_TYPE, Fs as LOCAL_STORAGE_LOGS_PANEL_OPEN, Is as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Ns as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Oi as require__baseUniq, Ps as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Qi as getNodeOutputs, Ta as deepCopy, Wa as NodeConnectionTypes, Xi as getConnectionTypes, Zi as getNodeInputs, bc as EnterpriseEditionFeature, dc as NDV_IN_FOCUS_PANEL_EXPERIMENT, hr as WEBHOOK_NODE_TYPE, ia as getSubworkflowId, ln as FORM_TRIGGER_NODE_TYPE, pr as UPDATE_WEBHOOK_ID_NODE_TYPES, qi as generateNodesGraph, sc as CANVAS_ZOOMED_VIEW_EXPERIMENT, sr as STICKY_NODE_TYPE, yi as require_cloneDeep, zo as VIEWS } from "./constants-C6S5WPU1.js";
import { k as defineStore, r as useRootStore } from "./_baseOrderBy-BY4x0dN2.js";
import { t as useExecutionsStore } from "./executions.store-Di1iqSdi.js";
import { t as usePinnedData } from "./usePinnedData-BATZCDOK.js";
import { t as useNodeCreatorStore } from "./nodeCreator.store-CATijmG4.js";
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-DzdCZb0z.js";
