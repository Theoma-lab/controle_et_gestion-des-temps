...
import { $ as N8nOption_default, An as N8nSpinner_default, At as N8nActionBox_default, Dn as N8nCallout_default, En as N8nHeading_default, On as N8nText_default, Q as N8nSelect_default, St as N8nTooltip_default, at as N8nCard_default, dt as N8nLoading_default, f as N8nBreadcrumbs_default, ht as N8nBadge_default, it as N8nInputLabel_default, jn as N8nIcon_default, kn as N8nButton_default, l as N8nInlineTextEdit_default, rt as N8nCheckbox_default, ut as N8nActionToggle_default, xt as N8nLink_default, y as N8nTags_default, z as N8nInfoTip_default } from "./src-BjCe3xxd.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-fRq25RGE.js";
import { T as createEventBus, v as useRoute, y as useRouter } from "./truncate-CiSH3Avz.js";
import { Ar as useStorage, Bt as ProjectTypes, C as useNodeTypesStore, Ca as FOLDER_NAME_ILLEGAL_CHARACTERS_REGEX, Dt as useTagsStore, Ea as ILLEGAL_FOLDER_CHARACTERS, Ma as COMMUNITY_PLUS_ENROLLMENT_MODAL, Mt as useTelemetry, Sa as FOLDER_LIST_ITEM_ACTIONS, Ta as FOLDER_NAME_ONLY_DOTS_REGEX, U as getEasyAiWorkflowJson, an as useDocumentTitle, br as useToast, fi as ResourceType, gr as useMessage, hr as useSourceControlStore, ls as useSettingsStore, nr as useCloudPlanStore, pn as useTemplatesStore, r as useUIStore, s as useWorkflowsStore, t as useUsersStore, tr as useTemplatesDataQualityStore, va as PROJECT_MOVE_RESOURCE_MODAL, vc as STORES, wa as FOLDER_NAME_MAX_LENGTH, wr as usePostHog, zt as useProjectsStore } from "./users.store-p-3LYLwz.js";
import "./sanitize-html-DeDnsMgc.js";
import "./empty-nq5-pHAR.js";
import { Cs as WORKFLOW_SHARE_MODAL_KEY, Jo as EXPERIMENT_TEMPLATE_RECO_V2_KEY, Ko as DUPLICATE_MODAL_KEY, Oa as jsonParse, Yo as EXPERIMENT_TEMPLATE_RECO_V3_KEY, bc as EnterpriseEditionFeature, gc as TEMPLATE_ONBOARDING_EXPERIMENT, i as DEFAULT_WORKFLOW_PAGE_SIZE, is as MODAL_CONFIRM, ko as getResourcePermissions, ks as LOCAL_STORAGE_EXPERIMENTAL_DISMISSED_SUGGESTED_WORKFLOWS, uo as PROJECT_ROOT, zo as VIEWS } from "./constants-C6S5WPU1.js";
import "./merge-DzkNhZhD.js";
import { A as storeToRefs, k as defineStore } from "./_baseOrderBy-BY4x0dN2.js";
import { t as require_dateformat } from "./dateformat-BeHi9sF4.js";
import { n as require_debounce, t as useDebounce } from "./useDebounce-CHQ-VByC.js";
import "./nodeIcon-BhljGdvK.js";
import { t as useFoldersStore } from "./folders.store-DVkp6gLO.js";
import "./ProjectIcon-BxQdKbwD.js";
import { t as ProjectCardBadge_default } from "./ProjectCardBadge-3kPvjall.js";
import { t as useUsageStore } from "./usage.store-BqwNnYFC.js";
import { t as Draggable_default } from "./Draggable-DKazOKy5.js";
import { t as NodeIcon_default } from "./NodeIcon-Bja_Y7pf.js";
import "./EnterpriseEdition.ee-DkB6KK1F.js";
import { t as TimeAgo_default } from "./TimeAgo-CwqC8luh.js";
import "./orderBy-BxNLjZ0X.js";
import "./ProjectSharing-ob6Ru6GK.js";
import "./TagsDropdown-CMudOYWg.js";
import { t as WorkflowTagsDropdown_default } from "./WorkflowTagsDropdown-D63LLfa6.js";
import { t as useInsightsStore } from "./insights.store-BV51RPnx.js";
import "./insights.constants-98xWnZQu.js";
import "./insights.utils-DKQj642P.js";
import { t as useMcp } from "./useMcp-D6F0TAw0.js";
import { n as usePersonalizedTemplatesV2Store, t as usePersonalizedTemplatesV3Store } from "./personalizedTemplatesV3.store-D4htJ_um.js";
import { t as TemplateCard_default } from "./TemplateCard-DeymIGo0.js";
import "./ProjectBreadcrumb-CI-Fq9lR.js";
import { t as FolderBreadcrumbs_default } from "./FolderBreadcrumbs-UDcwrV-F.js";
import { t as useAITemplatesStarterCollectionStore } from "./aiTemplatesStarterCollection.store-BCMCjfaH.js";
import { n as useProjectPages, t as useReadyToRunStore } from "./readyToRun.store-DbUBrQhn.js";
import { t as useReadyToRunWorkflowsStore } from "./readyToRunWorkflows.store-D1A32I9D.js";
import { t as EmptySharedSectionActionBox_default } from "./EmptySharedSectionActionBox-ityp7dc5.js";
import { t as ResourcesListLayout_default } from "./ResourcesListLayout-CwdIpORb.js";
import "./ResourceFiltersDropdown-pCZW412_.js";
import { t as ProjectHeader_default } from "./ProjectHeader-BBJ6qTDc.js";
import { t as useMCPStore } from "./mcp.store-CC617H-q.js";
import { t as InsightsSummary_default } from "./InsightsSummary-C_Zaydj9.js";
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(N8nCard_default), {
				...
				header: withCtx(() => [createVNode(unref(N8nText_default), {
					...
					default: withCtx(() => [createTextVNode(toDisplayString(__props.data.name) + " ", 1), !workflowPermissions.value.update ? (openBlock(), createBlock(unref(N8nBadge_default), {
						key: 0,
						class: "ml-3xs",
						theme: "tertiary",
						bold: ""
...
const cardLink = "_cardLink_1dm19_123";
const cardHeading = "_cardHeading_1dm19_133";
const cardHeadingArchived = "_cardHeadingArchived_1dm19_142";
const cardDescription = "_cardDescription_1dm19_150";
const cardTags = "_cardTags_1dm19_160";
const cardActions = "_cardActions_1dm19_165";
const cardBadge = "_cardBadge_1dm19_176";
const cardArchived = "_cardArchived_1dm19_187";
const publishIndicator = "_publishIndicator_1dm19_201";
const publishIndicatorDot = "_publishIndicatorDot_1dm19_214";
const breadcrumbs = "_breadcrumbs_1dm19_233";
var WorkflowCard_vue_vue_type_style_index_0_lang_module_default = {
	cardLink,
	cardHeading,
	cardHeadingArchived,
	"description-popper": "_description-popper_1dm19_146",
	cardDescription,
	cardTags,
	cardActions,
	cardBadge,
	"with-breadcrumbs": "_with-breadcrumbs_1dm19_180",
	cardArchived,
	"description-cell--mcp": "_description-cell--mcp_1dm19_193",
	publishIndicator,
	publishIndicatorDot,
	breadcrumbs
};
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return shouldUseSimplifiedLayout.value ? (openBlock(), createBlock(EmptyStateLayout_default, {
				...
				"onUpdate:filters": [_cache[6] || (_cache[6] = ($event) => filters.value = $event), onFiltersUpdated],
				...
				empty: withCtx(() => [unref(projectPages).isSharedSubPage && personalProject.value ? (openBlock(), createBlock(EmptySharedSectionActionBox_default, {
				...
				}, null, 8, ["personal-project"])) : (openBlock(), createElementBlock("div", _hoisted_1, [
					...
					!readOnlyEnv.value && projectPermissions.value.workflow.create ? (openBlock(), createElementBlock("div", {
						...
						showAIStarterCollectionCallout.value ? (openBlock(), createBlock(unref(N8nCard_default), {
							key: 0,
							class: normalizeClass(_ctx.$style.emptyStateCard),
							hoverable: "",
				...
				filters: withCtx(({ setKeyValue }) => [
					...
					createBaseVNode("div", _hoisted_5, [createVNode(unref(N8nCheckbox_default), {
